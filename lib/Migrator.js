    ...
    migrateNucleicDerivatives: function(mysqlSampleId, idSubj) {
        ...
        .then(function(qcRows) {
            ...
            return BluebirdPromise.each(qcRows, function(qc, index) {
                ...
                if (!_.isEmpty(qc)) {
                    metadata.quality = {value: qc.JSON_SCHEMA.body[0].content[0].instances[0].value};
                    metadata.kit_type = {value: qc.JSON_SCHEMA.body[0].content[1].instances[0].value};
                    metadata["260/280"] = {value: qc.JSON_SCHEMA.body[0].content[2].instances[0].value};
                    metadata["260/230"] = {value: qc.JSON_SCHEMA.body[0].content[3].instances[0].value};
                }
