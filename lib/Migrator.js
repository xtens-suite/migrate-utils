...
const coroutines = {
    ...
    migrateCGH: BluebirdPromise.coroutine(function* (folder, ext, processInfo) {
        ...
        yield BluebirdPromise.each(files,co.wrap( function *(file, daemonIndex) {
            ...
            if (resCGHRaw.statusCode !== CREATED) {
                ...
                daemons[daemonIndex] = yield DaemonService.ErrorDeamon( daemons[daemonIndex], resCGHRaw.body, objInfo.bearerToken);
                return;
            }
            ...
            if (resCGHProc.statusCode !== CREATED) {
                ...
                daemons[daemonIndex] = yield DaemonService.ErrorDeamon( daemons[daemonIndex], resCGHProc.body, objInfo.bearerToken);
                return;
            }
            ...
            if (resGenProf.statusCode !== CREATED) {
                ...
                daemons[daemonIndex] = yield DaemonService.ErrorDeamon( daemons[daemonIndex], resGenProf.body, objInfo.bearerToken);
                return;
            }
    ...
    migrateVCF: BluebirdPromise.coroutine(function* (folder, ext, processInfo, knexAnno) {
        ...
        yield BluebirdPromise.each(files,co.wrap( function *(file, daemonIndex) {
          //     fileNames.push(file.split(folder)[1]);
            let notInserted = [], created = 0;
