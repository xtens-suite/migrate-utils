...
Migrator.prototype = {
    ...
    importCBInfo: function(folder, ext) {
        ...
        // logger.log('info',patients);

        let updated = 0, created = 0;
        let name, surname, birthDate, idSubject, patient, metadataCBInfo, subjects, cbInfos;
        ...
        .spread(function(res, body) {
            if (res && res.statusCode !== OK || !body) {
                return undefined;
            }
            subjects = body && body.data;
            logger.log('info',subjects[0]);
