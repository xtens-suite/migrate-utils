...
Migrator.prototype = {
     ...
     */
    migrateNucleicDerivatives: function(mysqlSampleId) {
        var that = this;
        var metadata;

        return this.knexMysql.select('BIT_CODE', 'ID_SAMPLE_TYPE', 'QUANTITY', 'EXTRACTION_DATE', 'CONCENTRATION').from('SAMPLE')
        ...
        .then(function(rows) {
            ...
            return BluebirdPromise.each(rows, function(sample) {
                ...
                that.knexPg.returning('id').insert({
