...
Migrator.prototype = {
    ...
    createPrimary: function(sample, idSubj, tumourStatus) {
        ...
        .spread(function(res, body) {
            ...
            if (res && res.statusCode !== 200) throw new Error("sample was not correctly created");
        ...
        return this.knexMysql.select(
            ...
            .then(function(rows) {
                ...
                return BluebirdPromise.each(rows, function(sample) {
                    ...
                    .spread(function(res, body) {
                        if (res.statusCode !== 200) throw new Error("Migrator.migrateSampleDerivatives - sample was not correctly created");
                        return true;
                    });
        ...
        .then(function(qcRows) {
            ...
            return BluebirdPromise.each(derivatives, function(derivative) {
                ...
                metadata = {
                    ...
                    quantity: {value: derivative.QUANTITY, unit: 'μg'},
                ...
                .spread(function(res, body) {
                    if (res.statusCode !== 200) {
                        ...
                        throw new Error("Migrator.migrateSampleDerivatives - sample was not correctly created");
                    }
                    console.log(body);
                    return true; 
                });
