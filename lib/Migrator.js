...
const coroutines = {
    ...
    GetInsertSampleNGS: BluebirdPromise.coroutine(function* (patient, daemons) {
    ...
    GetInsertAnalysisNGS: BluebirdPromise.coroutine(function* (patient, daemons) {
    ...
    GetInsertPatientNGS: BluebirdPromise.coroutine(function* (patient, daemons) {
    ...
    yield BluebirdPromise.each(patients, co.wrap(function* (patient, index) {
        ...
        yield BluebirdPromise.each(families, co.wrap(function* (familyID) {
            ...
            yield BluebirdPromise.each(probands, co.wrap(function* (proband) {
                ...
                let resPat = yield that.GetInsertPatientNGS(proband, daemons);
                proband = resPat.patient;
                daemons = resPat.daemons;

                probandsID.push(proband.id)

                const resSample = yield that.GetInsertSampleNGS(proband, daemons);
                proband = resSample.patient;
                daemons = resSample.daemons;

                if (!relative['Seq Type'] && !relative['Platform'] && !relative['KIT']) {
                const resAnalysis = yield that.GetInsertAnalysisNGS(proband, daemons);
            ...
            yield BluebirdPromise.each(family, co.wrap(function* (relative) {
                ...
                let resPat = yield that.GetInsertPatientNGS(relative, daemons);
                relative = resPat.patient;
                daemons = resPat.daemons;

                const resSample = yield that.GetInsertSampleNGS(relative, daemons);
                ...
                if (!relative['Seq Type'] && !relative['Platform'] && !relative['KIT']) {
                    ...
                    const resAnalysis = yield that.GetInsertAnalysisNGS(relative, daemons);
