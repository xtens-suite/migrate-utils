...
var enumFields = ['Genomic Profile'];
 ...
 */
    function composeCNVMetadata(cnvArr) {
        ...
        var geneNames = cnvArr[9] && cnvArr[9].split(",").map(Function.prototype.call, String.prototype.trim);
        metadata.gene_name = {values: geneNames || []};
        var mirnas = cnvArr[11] && cnvArr[11].split(",").map(Function.prototype.call, String.prototype.trim);
    ...
    function composeCGHMetadata(filePath) {
        ...
        var metadataCGHProcessed = composeCGHProcessedMetadata(acghProcessedFields);

        // Extract metadataGenomicProfile from metadataCGHProcessed
        var type=metadataCGHProcessed['type'];
        var sca_type=metadataCGHProcessed['sca_type'];
        var metadataGenomicProfile= {type,sca_type};
